...
<div class="top">
    ...
    <div class="search">
        <form action="/home/list" method="get">
            <input type="text" value="" name="search" class="s_ipt" style="height: 40px;" />
            <input type="submit" value="搜索" class="s_btn" />
        </form>                      
        <span class="fl"><a href="#">咖啡</a><a href="#">iphone 6S</a><a href="#">新鲜美食</a><a href="#">蛋糕</a><a href="#">日用品</a><a href="#">连衣裙</a></span>
    </div>
    <div class="i_car">
        <div class="car_t">购物车 [ <span>{{ $countCar }}</span> ]</div>
        <div class="car_bg">
            <!--Begin 购物车未登录 Begin-->
            ...
            <div class="price_a"><a href="/home/car/index">去购物车结算</a></div>
            <!--End 购物车已登录 End-->
        </div>
    </div>
</div>
